...
using Voxand;
using Sparkvox.src.UI;
using Sparkvox.src.Features;
using Sparkvox.src.Features.Voxels.Editing;
using Sparkvox.src.Features.Voxels.Map;
using Sparkvox.src.Features.Voxels.Materials;
using Sparkvox.src.Features.Voxels.Map.Generation;
using Sparkvox.src.Services;

namespace Sparkvox.src.ExecutionControl;
public sealed class PrimaryManager : ExecutionManager
{
    ...
    public override void Load(Window win)
    {
        ...
        VoxelBrickmap brickmap = new(numberOfChunks * 4);
        ...
        serviceRegistrator.AddOrReplaceService<IVoxelMapPersistence>(chunkMap);
        ...
        UI_Manager.AddWindow(new UI_MapSettings());
    ...
    public override void Unload()
    {
        ...
        if (ServiceLocator.TryGetService<IVoxelMap>(out var map))
            map.Dispose();

        if (ServiceLocator.TryGetService<IVoxelPalette>(out var palette)) 
            palette.Dispose();
