...
public class ImGuiController : IDisposable
{
    ...
    public ImGuiController(int width, int height)
    {
        ...
        styleSerializationOptions = new() { IncludeFields = true, WriteIndented = true };
...
void main()
{
    ...
    public static unsafe void SetStyle(ImGuiStyle style)
    {
        *ImGui.GetStyle().NativePtr = style;
    }
    public static unsafe void SetStyle(string styleJSON)
    {
        ImGuiStyle style;
        try
        {
            style = JsonSerializer.Deserialize<ImGuiStyle>(styleJSON, styleSerializationOptions);
            *ImGui.GetStyle().NativePtr = style;
        }
        catch (Exception e) { Console.WriteLine("Failed to load ImGui style:\n" + e.Message); }
    }
    public static string GetStyleJSON()
    {
        ImGuiStylePtr stylePtr = ImGui.GetStyle();
        unsafe
        {
            ImGuiStyle style = *stylePtr.NativePtr;
            return JsonSerializer.Serialize(style, styleSerializationOptions);
        }
    }
}